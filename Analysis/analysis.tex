...
%
%\begin{lstlistings}
%WHILE (veto_complete = False)DO
%	FOR((no_of_maps - 1) /2)DO
%		Team 1 veto stage
%		Team 2 veto stage
%	add last map to maps to be played
%	veto_complete <- True
%give veto sheet to production
%create and show stream graphic
%give veto info to casters
%\end{lstlisting}
